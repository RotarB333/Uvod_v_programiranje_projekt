...
okno = tk.Tk()
pricni_igro()
stanje_igre=tk.Label(okno, text = 'Igralec :[' + str(player_hp) + '/' + str(M_player_hp) +
                     ']\n Stanje igralca:'+ stanje_player + '\n' + 'Zmaj :['+ str(boss_hp) + ']')
stanje_igre.grid(row=0,column = 1)
oznaka=tk.Label(okno, text='Izberi potezo')
oznaka.grid(row=1,column=1)
izberi_0=tk.Button(okno, text='ZDRAVLJENJE',bg='light green')
izberi_0.grid(row=2,column=1)
izberi_1=tk.Button(okno, text='OGNJENA KROGLA',bg='red')
izberi_1.grid(row=3,column=1)
stanje_igre.config(okno, text = 'Igralec :[' + str(player_hp))
okno.mainloop()
